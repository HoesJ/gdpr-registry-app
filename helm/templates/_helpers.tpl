...
{{- printf "%s.%s" .Values.ingress.subdomain "production.eks.romcore.cloud" -}}
  {{- else -}}
{{- printf "%s.%s" .Values.ingress.subdomain "staging.eks.romcore.cloud" -}}
  {{- end -}}
 {{- else -}}
  {{- if .Values.ingress.production -}}
{{- printf "%s.%s" $name "production.eks.romcore.cloud" -}}
  {{- else -}}
{{- printf "%s.%s" $name "staging.eks.romcore.cloud" -}}
  {{- end -}}
 {{- end -}}
{{- end -}}
{{- end -}}
...
{{- define "project.baseDomain" -}}
  {{- if .Values.ingress.production -}}
{{- printf "production.eks.romcore.cloud" -}}
  {{- else -}}
{{- printf "staging.eks.romcore.cloud" -}}
  {{- end -}}
{{- end -}}
